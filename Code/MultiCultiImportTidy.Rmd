...
TargetFile <- "20250128_B2201_MCMIX004_567_156.csv"
TubeLabels = 567
Light = 180
...
# Plot data with logistic curve fits
```{r logistic plots}
TargetDataGrowth %>%
...
write_csv(TargetDataWideFilter, file = file.path(DataOut, paste("MultiCultiTubes", TubeLabels, ".csv", sep = ""))
)
